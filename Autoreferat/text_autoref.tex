...
\vspace{-0.5 cm}
 ...
 \begin{table}[h!]
 	\captionsetup{margin={1cm,0cm}, font = footnotesize}\caption{Porównanie wyników wnioskowania z wykorzystaniem zbioru testowego dla metody proponowanej tj. SVR oraz metody wyszkolonej w paradygmacie end-to-end. Pogrubieniem oznaczono najlepsze rezultaty, a kolorem czerwonym istotne statystycznie różnice w liczonych średnich ($p$ $<$ 0,05).}
 	\vspace{-0.5cm}
 	\tiny
 	\begin{center}
