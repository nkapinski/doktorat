...
Rehabilitacja po urazie również podzielona jest ze względu na fazy gojenia. W pierwszej fazie terapia skupia się wokół ochrony miejsca urazu, odciążenia nogi, redukcji obrzęku i złagodzenia stanu zapalnego. W drugiej fazie zabiegi rehabilitacyjne są kontynuacją działań wykonywanych podczas pierwszej fazy, ze szczególnym naciskiem na przeciwdziałanie powstawania zrostów poprzez pracę nad ślizgiem ścięgna oraz mobilizacją tkanek miękkich. Trzeci etap tj. przebudowa to najdłuższy z etapów gojenia się tkanek ścięgnistych, podczas którego zachodzi najwięcej zmian zarówno w strukturze jak i odporności ścięgna oraz jego funkcji. W tym okresie można wyszczególnić następujące cele rehabilitacji: 
\begin{itemize}
...
\end{itemize}
/*opisz dokładniej przykłady fizjo i fizykoterapii*/ 
Dlatego oprócz podstawowych zabiegów ochronnych i fizjoterapii do działań włącza się zabiegi fizykoterapii np. elektrostymulacje, magnetoterapie czy laseroterapię. Testowane są również nowe rozwiązania bazujące na dostarczaniu komórek macierzystych do tkanki [START, CMC]. 

Dla każdego z pacjentów najistotniejszym celem jest możliwie szybki powrót do pełnej sprawności. Oceną poziomu można realizować przez różnego rodzaju techniki. Najczęściej stosowane zostały scharakteryzowane w kolejnych sekcjach.
