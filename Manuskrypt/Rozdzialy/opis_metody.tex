...
Można zaobserwować, że najmniejsze błędy ($<=$1) otrzymywane są w zakresie ocen 2--4. Dla oceny 5 wynik jest nieznacznie gorszy i osiąga poziom MAE=1,15. W pozostałych ocenach największy błąd wynosi $>$ 1,5. Powyższe obserwacje są związane z faktem, że metoda automatyczna charakteryzuje się mniejszym zakresem oceny, co wynika z zastosowania w algorytmie meta-regresji. Wartości oceny nigdy nie osiągają wartości skrajnych tj. 7 lub 0--1. 
