...
\end{equation}
gdzie $A$ jest macierzą przekształcenia liniowego, a b wektorem przesunięcia. Jako przykłady takich przekształceń można wymienić:
\begin{itemize}
