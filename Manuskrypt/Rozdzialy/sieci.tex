...
W sieciach konwolucyjnych filtry pogrupowane są w tzw. \textit{wartstwy konwolucyjne} stanowiące główną składową części sieci pełniącą funkcję ekstrakcji cech obrazowych. Drugim kompont sieci odpowiedzialny jest za klasyfikacje wybranych cech i ostateczne rozróżnienie zbioru. Ewolucja sieci konwolucyjnych do obecnej postaci przebiegała stopniowo, a najważniejsze jej elementy zostały przedstawione w kolejnych podsekcjach. 
