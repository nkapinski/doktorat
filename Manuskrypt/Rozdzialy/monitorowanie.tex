...
Skurcz mięśni szkieletowych trwa 100--300 milisekund. Schemat czasów poszczególnych aktywacji przedstawiono na Rys. \ref{muscle-excitements}. 
\begin{figure}[h!]
	\centering
...
Jądra atomowe wirujące z częstotliwością Larmora na skutek silnego pola magnetycznego ulegają swego rodzaju uporządkowaniu, tworząc rotujące w przybliżony sposób wektory magnetyzacji. Dodatkowo istotne jest, że jądra o spinach ustawionych równolegle mają mniejsze energie,
a o ustawionych antyrównolegle większe. Jest możliwe zatem, na skutek sekwencji impulsów fal radiowych, aby spiny jąder uległy odchyleniu. W przeciętnym wycinku ciała ludzkiego jest znacząco więcej jąder o ustawieniu równoległym niż antyrównoległym. Przykładowo, w stosunkowo niewielkim w porównaniu z wymiarami typowo obrazowanych struktur anatomicznym kawałku objętości 1 $\times$ 1 $\times$ 5 mm, jest to liczba około 2 $\times$ $10^{15}$ cząstek w polu o indukcji 1,5T. 
