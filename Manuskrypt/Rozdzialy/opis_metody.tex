...
Calka z pola pod min i diagonali: 
SCT (18)	TT (10)	STE (42)	TE (13)	TU (30)	TisE (17)

Podsumowanie wizualne:
\begin{figure}[h!]
	\centering
	\includegraphics[width=1\textwidth]{figures/cm_summary.png}
	\caption{Odległość minimum od diagonali.}\label{fig:CM_MAE_SUMMARY}
\end{figure}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1\textwidth]{figures/cmScores_summary.png}
