...
Szczątkowe badania biomechaniczne są najczęściej realizowanymi pomiarami w praktyce. Bardziej kompleksowe podejście stanowi modelowanie układu mięśniowo-szkieletowego. Metody te rozwinęły się...

Recent advancements in biomechanics combined with mathematical modelling have produced powerful tools for parameterizing of the human musculoskeletal system. The computer based musculoskeletal modelling started in the early 1990s when Delp and Loan introduced musculoskeletal modelling environment, called SIMM. This fact sparked multiple biomechanical researcher including simulations of walking, cycling, running, consequences of surgical procedures etc.. Nowadays, along with other commercial products such as Visual 3D (Cmotion Inc.), Anybody (Anybody Technology) or Adams (MSC Software Corp.), Simm provides tools for musculoskeletal system models formulation and simulation of movement. Noncommercial products such as Human Motion (Riken, Japan) or OpenSim (Stanford University) are also available. 
