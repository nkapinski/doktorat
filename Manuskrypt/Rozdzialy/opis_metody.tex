...
\end{equation}
gdzie $TM$\index{$TM$ -- średnia trymowana} jest średnią trymowaną z marginesami 2,5\%, a $R(x_i)$\index{$R(x_i)$ -- wynik regresji} jest wynikiem regresji obliczonym dla przekroju poprzecznego $x_i$, gdzie $i$ to indeks przekroju w trójwymiarowym badaniu RM.
